...
func (p *CreditCard) GetCryptogram() int32 {
  return p.Cryptogram
}

func (p *CreditCard) GetHolder() string {
  return p.Holder
}

func (p *CreditCard) GetDate() int64 {
  return p.Date
}
func (p *CreditCard) Read(iprot thrift.TProtocol) error {
...
func (p *CreditCard) Write(oprot thrift.TProtocol) error {
...
type Payment interface {
  // Parameters:
  //  - Card
  Authorize(ctx context.Context, card *CreditCard) (r bool, err error)
  // Parameters:
  //  - Card
  //  - Amount
  Pay(ctx context.Context, card *CreditCard, amount int32) (r bool, err error)
}
...
// Parameters:
//  - Card
func (p *PaymentClient) Authorize(ctx context.Context, card *CreditCard) (r bool, err error) {
...
//  - Card
//  - Amount
func (p *PaymentClient) Pay(ctx context.Context, card *CreditCard, amount int32) (r bool, err error) {
...
var retval bool
  var err2 error
  if retval, err2 = p.handler.Authorize(ctx, args.Card); err2 != nil {
...
var retval bool
  var err2 error
  if retval, err2 = p.handler.Pay(ctx, args.Card, args.Amount); err2 != nil {
...
type PaymentAuthorizeArgs struct {
  Card *CreditCard `thrift:"card,1" db:"card" json:"card"`
}
...
var PaymentAuthorizeArgs_Card_DEFAULT *CreditCard
func (p *PaymentAuthorizeArgs) GetCard() *CreditCard {
  if !p.IsSetCard() {
    return PaymentAuthorizeArgs_Card_DEFAULT
  }
return p.Card
}
func (p *PaymentAuthorizeArgs) IsSetCard() bool {
  return p.Card != nil
}
...
func (p *PaymentAuthorizeArgs)  ReadField1(iprot thrift.TProtocol) error {
  p.Card = &CreditCard{}
...
func (p *PaymentAuthorizeArgs) writeField1(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("card", thrift.STRUCT, 1); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:card: ", p), err) }
  if err := p.Card.Write(oprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error writing struct: ", p.Card), err)
  }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 1:card: ", p), err) }
  return err
}
...
var PaymentPayArgs_Card_DEFAULT *CreditCard
func (p *PaymentPayArgs) GetCard() *CreditCard {
  if !p.IsSetCard() {
    return PaymentPayArgs_Card_DEFAULT
  }
return p.Card
}
...
func (p *PaymentPayArgs) IsSetCard() bool {
  return p.Card != nil
}
...
func (p *PaymentPayArgs)  ReadField2(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(); err != nil {
  return thrift.PrependError("error reading field 2: ", err)
} else {
  p.Amount = v
...
func (p *PaymentPayArgs) writeField2(oprot thrift.TProtocol) (err error) {
