...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  bool Authorize(CreditCard card)")
  fmt.Fprintln(os.Stderr, "  bool Pay(CreditCard card, i32 amount)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := payment.NewPaymentClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "Authorize":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "Authorize requires 1 args")
      flag.Usage()
    }
    arg6 := flag.Arg(1)
    ...
    argvalue0 := payment.NewCreditCard()
    ...
    value0 := argvalue0
    fmt.Print(client.Authorize(context.Background(), value0))
    fmt.Print("\n")
    break
  case "Pay":
    if flag.NArg() - 1 != 2 {
      fmt.Fprintln(os.Stderr, "Pay requires 2 args")
      flag.Usage()
    }
    arg12 := flag.Arg(1)
    ...
    value1 := argvalue1
    fmt.Print(client.Pay(context.Background(), value0, value1))
    fmt.Print("\n")
    break
  case "":
    Usage()
